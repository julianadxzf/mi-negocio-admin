...
import { BarChart3, Users, Package, DollarSign, Plus, Edit, Trash2, Phone, Mail, LogOut, Eye, Check, X } from 'lucide-react'
...
export default function BusinessAdmin() {
  ...
  // Vista para administrador - continúa en el siguiente mensaje...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
